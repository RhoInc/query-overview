(function (global, factory) {
    ...
    function styles() {
      ...
      '.qo-component--chart {' + '    width: 59.5%;' + '    float: right;' + '}', '.qo-component--chart .legend {' + '    display: flex !important;' + '    justify-content: space-evenly;' + '}',
    ...
    function groupControls() {
        ...
        this.controls.otherControls.container.append('div').classed('qo-control-grouping--label', true).text('Controls');
    ...
    function updateGroupByOptions() {
        ...
        var groupByControl = this.controls.wrap.selectAll('.control-group select').filter(function (d) {
