(function (global, factory) {
    ...
    function styles() {
      ...
      '.qo-component--controls {' + '    width: 39.5%;' + '    float: left;' + '    position: relative;' + '}', '.qo-control-grouping {' + '    display: inline-block;' + '}', '.qo-button--reset-chart {' + '    position: absolute;' + '    top: 0;' + '    left: 0;' + '}', '.wc-control-label {' + '    cursor: help;' + '}', '.span-description {' + '    display: none !important;' + '}',
      ...
      '.qo-component--chart {' + '    width: 59.5%;' + '    float: right;' + '}', '.qo-component--chart .legend-title {' + '    cursor: help;' + '}',

      /***--------------------------------------------------------------------------------------\
        Listing
      \--------------------------------------------------------------------------------------***/

      '.qo-component--listing {' + '}', '.query-table-container {' + '    overflow-x: auto;' + '    width: 100%;' + '    transform: rotate(180deg);' + '    -webkit-transform: rotate(180deg); ' + '}', '.query-table {' + '    transform: rotate(180deg);' + '    -webkit-transform: rotate(180deg); ' + '}'];
    ...
    function groupControls() {
        ...
        this.controls.otherControls.label = this.controls.otherControls.container.append('div').classed('qo-control-grouping--label', true).text('Controls');
        ...
        this.controls.filters.container.append('div').classed('qo-control-grouping--label', true).text('Filters');
    ...
    function addSelectAll() {
        this.controls.filters.labels.each(function (d) {
            ...
            var checkbox = label.select('input').attr('title', 'Deselect All ' + d.label + ' Options').property('checked', true).on('click', function (di) {
