...
The sections below describe each query-overview setting as of version 2.1.4.
...
# Webcharts settings
The objects below contain Webcharts settings for each display as of version 2.1.4 of the Query Overview.
