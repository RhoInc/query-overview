  ...
  //Define detail listing settings.
    ...
    if (!this.config.details) {
        this.listing.config.headers[
            this.listing.config.headers.indexOf(this.config.form_col)] = 'Form';
        this.listing.config.headers[
            this.listing.config.headers.indexOf(this.config.field_col)] = 'Field';
        this.listing.config.headers[
            this.listing.config.headers.indexOf(this.config.status_col)] = 'Status';
    }
